...
var Search = /*#__PURE__*/function (_Component) {
  ...
  function Search() {
    ...
    _defineProperty(_assertThisInitialized(_this), "searchArtist", function (props) {
      _this.props.search(_this.state.artistQuery);
    });
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("h2", null, "Music Master"), /*#__PURE__*/_react.default.createElement("input", {
...
var Artist = function Artist(props) {
  ...
  var _props$artist = props.artist,
      images = _props$artist.images,
      name = _props$artist.name,
      followers = _props$artist.followers,
      genres = _props$artist.genres,
      popularity = _props$artist.popularity;
  return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("img", {
    src: images[1] && images[1].url,
    alt: "artist-profile",
    className: "artist-image"
  }), /*#__PURE__*/_react.default.createElement("h2", null, name), /*#__PURE__*/_react.default.createElement("p", null, "Genres: ", genres.join(', ')), /*#__PURE__*/_react.default.createElement("p", null, "Followers: ", followers.total));
};
...
var Tracks = /*#__PURE__*/function (_Component) {
  ...
  function Tracks() {
    ...
    _defineProperty(_assertThisInitialized(_this), "playAudio", function (previewUrl) {
      return function () {
        ...
        if (previewUrl == null) {
          ...
          _this.state.pausedAudio.play();
        } else if (_this.state.playingAudio.src !== audio.src) {
          _this.state.playingAudio.pause();
    ...
    _defineProperty(_assertThisInitialized(_this), "previewButton", function (previewUrl) {
      if (previewUrl && _this.state.playing && _this.state.playingAudio.src === previewUrl) {
  ...
  _createClass(Tracks, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", null, this.props.tracks.map(function (track) {
        var id = track.id,
            name = track.name,
        ...
        }), /*#__PURE__*/_react.default.createElement("p", null, name), /*#__PURE__*/_react.default.createElement("p", null, _this2.previewButton(preview_url)));
      }));
    }
  }]);
...
var _default = Tracks;
exports.default = _default;
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js"}],"Components/App.js":[function(require,module,exports) {
"use strict";
...
var BASE_URL = 'https://spotify-api-wrapper.appspot.com';
...
var App = /*#__PURE__*/function (_Component) {
  ...
  function App() {
    ...
    _defineProperty(_assertThisInitialized(_this), "searchArtist", function (artistQuery) {
      console.log('searchArtist', _this.state);
      fetch("".concat(BASE_URL, "/artist/").concat(artistQuery)).then(function (response) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getArtistTopTrack", function () {
      fetch("".concat(BASE_URL, "/artist/").concat(_this.state.artist.id, "/top-tracks")).then(function (response) {
        return response.json();
      }).then(function (data) {
        _this.setState({
          tracks: data.tracks
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      }), /*#__PURE__*/_react.default.createElement("hr", null), /*#__PURE__*/_react.default.createElement("h2", null, "Top Tracks"), /*#__PURE__*/_react.default.createElement(_Tracks.default, {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "62519" + '/');
